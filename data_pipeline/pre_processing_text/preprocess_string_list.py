...
def preprocessing_list(list_of_strings, list_of_regex=list_of_regex, stopwords_list=english_stopwords):
    """
...
def preprocessing_string(string_text, list_of_regex=list_of_regex, stopwords_list=english_stopwords):
    """
    Apply the preprocessing functions to clean
    and normalize a list of string.
